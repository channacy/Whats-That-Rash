            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        { "type": "text", "text": "Within 1000 characters, analyse the image and create a report to highlight what condition it most likely is, and in bullet points, provide medical recommendations. Make sure the average user will be able to understand the report." },
                        { "type": "text", "text": desc },
                        {
                            "type": "image_url",
                            "image_url": {
                ...
                messages = [
                    {
                        ...
                        "content": [
                            { "type": "text", "text": "You are a dermatologist that assesses skin conditions" },
                            { "type": "text", "text": "Within 1000 characters, with the tile being 'WTR Report' analyse the image and create a report to highlight what condition it most likely is, and in bullet points, provide medical recommendations. Make sure the average user will be able to understand the report." },
                            {
                                "type": "image_url",
                                "image_url": {
                                    "url": f"data:image/jpeg;base64,{base64_image}",
